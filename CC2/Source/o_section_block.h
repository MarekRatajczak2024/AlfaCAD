...
extern int create_profile_block(char *units_system, char *series0, char *type0, double h, double b, double tw, double tf, double r1, double r2, double sf, double bt, double bb, double bf, double t, double ha, double ba, double ab, double c, double c1, double r3, double ri, double sw);
