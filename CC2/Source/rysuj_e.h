...
extern unsigned char *mkbuf, *mbufmx;
...
extern void komunikat_len(int);
extern void komunikat_str(char  *st);
extern void komunikat_str_short_reset(void);
extern void komunikat_str_short_mask(BOOL center);
...
extern double jednostkiObmm(double mob);
...
extern double milimetryobxl(double x0, double y0, int cartflags) ;
extern double milimetryobyl(double x0, double y0, int cartflags) ;
...
extern int atoi_(const char *st);
extern long atol_(const char *st);
extern BOOL RETINA;
