...
#define ALLEGRO_LEGACY_HAVE_DIRENT_H
#define ALLEGRO_LEGACY_HAVE_INTTYPES_H
/* #undef ALLEGRO_LEGACY_HAVE_LINUX_AWE_VOICE_H */
#define ALLEGRO_LEGACY_HAVE_LINUX_INPUT_H
#define ALLEGRO_LEGACY_HAVE_LINUX_JOYSTICK_H
#define ALLEGRO_LEGACY_HAVE_LINUX_SOUNDCARD_H
/* #undef ALLEGRO_LEGACY_HAVE_MACHINE_SOUNDCARD_H */
/* #undef ALLEGRO_LEGACY_HAVE_SOUNDCARD_H */
#define ALLEGRO_LEGACY_HAVE_STDINT_H
/* #undef ALLEGRO_LEGACY_HAVE_SV_PROCFS_H */
#define ALLEGRO_LEGACY_HAVE_SYS_IO_H
#define ALLEGRO_LEGACY_HAVE_SYS_SOUNDCARD_H
#define ALLEGRO_LEGACY_HAVE_SYS_STAT_H
#define ALLEGRO_LEGACY_HAVE_SYS_TIME_H
#define ALLEGRO_LEGACY_HAVE_SYS_UTSNAME_H

/* Define to 1 if the corresponding functions are available. */
/* #undef ALLEGRO_LEGACY_HAVE_GETEXECNAME */
#define ALLEGRO_LEGACY_HAVE_MEMCMP
#define ALLEGRO_LEGACY_HAVE_MKSTEMP
#define ALLEGRO_LEGACY_HAVE_MMAP
#define ALLEGRO_LEGACY_HAVE_MPROTECT
#define ALLEGRO_LEGACY_HAVE_POSIX_MONOTONIC_CLOCK
#define ALLEGRO_LEGACY_HAVE_SCHED_YIELD
/* #undef ALLEGRO_LEGACY_HAVE_STRICMP */
/* #undef ALLEGRO_LEGACY_HAVE_STRLWR */
/* #undef ALLEGRO_LEGACY_HAVE_STRUPR */
#define ALLEGRO_LEGACY_HAVE_SYSCONF

/* Define to 1 if procfs reveals argc and argv */
/* #undef ALLEGRO_LEGACY_HAVE_PROCFS_ARGCV */
...
/* #undef ALLEGRO_LEGACY_BIG_ENDIAN */
