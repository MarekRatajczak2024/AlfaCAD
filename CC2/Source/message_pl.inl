...
/*155*/u8"Rzędne p.p.t. warstw odwiertu nie są narastające",
/*156*/u8"Rzędna p.p.t. pierwszej warstwy = 0",
...
/*204*/u8"Nieprawidłowa wartość współczynnika skali X/Y profilu",
...
/*214*/u8"Numer warstwy poza zakresem 1...2048",
...
/*115*/u8"Maksymalny numer warstwy: 2048",
...
/*128*/u8"Podaj średnicę kanału projektowanego [mm]: ",
/*129*/u8"Podaj średnicę kanału istniejącego mm]: ",
...
/*135*/u8"Podaj wartość stałego zagłębienia [m]: ",
...
/*184*/u8"Podaj kąt obrotu bloku brazu (°): ",
/*185*/u8"Wczytać ponownie zmieniony blok obrazu ? (Tak / Nie / Esc): ",
/*186*/u8"<Blok parametryczny> Podaj współczynnik skali X/Y profilu: ",
...
/*190*/u8"Wskaż sieć do generowania bloków studni",
...
/*228*/u8"",
/*229*/u8"",
/*230*/u8"Oznaczono rysunek jako mapa sieci",
/*231*/u8"Rysunek jest już oznaczony jako mapa sieci",
/*232*/u8"Rysunek jest już oznaczony jako profil sieci",
/*233*/u8"PROFIL ZABLOKOWANY!",
/*234*/u8"",
};
...
#define _PROFILE_COLORS_ u8"@Kolory elementów profilu/mapy"

#define _measurement_axis_ u8"oś pomiaru"
#define _existing_ground_line_ u8"linia terenu istniejącego"
#define _designed_ground_line_ u8"linia terenu projektowanego"
#define _street_line_ u8"linia ulicy"
#define _existing_canal_line_ u8"linia kanalu istniejącego"
#define _designed_canal_line_ u8"linia kanalu projektowanego"
#define _elevation_values_ u8"wartości rzędnych"
#define _l_material_ u8"Φ, l, materiał"
#define _distances_	u8"odległości"
#define _hectometers_ u8"hektometry"
#define _installation_description_ u8"opis instalacji"
...
#define	_hole_axis_ u8"oś otworu"
#define _hole_number_ u8"numer otworu"
#define _hole_description_ u8"opis otworu"
#define _layers_description_ u8"opis warstw"
#define _water_symbol_ u8"symbol wody"
#define _other_ u8"inny"

#define _OBJECT_COLORS_ u8"KOLORY OBIEKTÓW"
#define _PROFILE_ELEMENT_COLOR_CONFIGURATION_ u8"KONFIGURACJA KOLORÓW ELEMENTÓW PROFILU"
