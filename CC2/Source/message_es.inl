...
#if defined(__MESSAGE__) || defined(CLANG_TIDY_PARSING_MODE)
...
/*105*/u8"La distancia no puede ser < 0", ///////////////////////////////////// //////
	/*106*/u8"El valor del factor (escala X / escala Y) del perfil debe ser > 0",
	/*107*/u8"La distancia es menor que la establecida en la sección anterior.",
	/*108*/u8"La distancia de la 'primera sección' no puede ser < 0",
	/*109*/u8"El valor inicial de los hectómetros no puede ser < 0",
	/*110*/u8"El valor final de los hectómetros debe ser > o = al inicial.",
	/*111*/u8"Error: EscalaX/EscalaY = 0. Se debe declarar una relación de escala > 0",
	/*112*/u8"La suma de distancias para los diámetros del canal existente excede la longitud del tramo",
	/*113*/u8"La suma de distancias para los diámetros del canal proyectado excede la longitud del tramo",
	/*114*/u8"Las longitudes establecidas para el canal existente y proyectado no son iguales para una distancia > 0.",
	/*115*/u8"La longitud establecida para el canal existente es < 0",
	/*116*/u8"La longitud establecida para el canal proyectado es < 0",
	/*117*/u8"La distancia (en esta variante) no puede ser <= 0",
	/*118*/u8"La longitud para la pendiente del canal existente excede la longitud del tramo",
	/*119*/u8"La longitud para la pendiente del canal proyectado excede la longitud del tramo",
	/*120*/u8"La pendiente del canal existente excede la diferencia de cotas del tramo",
	/*121*/u8"La pendiente del canal proyectado excede la diferencia de cotas del tramo",
	/*122*/u8"Valor de escala de perfil no válido. Seleccione la función /Factor de escala/",
	/*123*/u8"Faltan los datos de la primera medición. Seleccione la función /Primera medición/",
/*124*/u8"Aviso: el punto de origen local <0,0> está en el punto de origen global 0,0. Presione cualquier tecla:",
		/*125*/u8"Se ha marcado el cable de energía eléctrica sin ingresar la cota del terreno",
	/*126*/u8"Se ha marcado la canalización telefónica sin ingresar la cota del terreno",
	/*127*/u8"Se ha marcado el cable telefónico sin ingresar la cota del terreno",
	/*128*/u8"La distancia es menor que el valor inicial en el eje de hectómetros",
	/*129*/u8"La distancia para la sección de instalación no puede ser <= 0",
	/*130*/u8"La distancia igual al primer hectómetro solo se puede establecer para la 'primera sección'",
	/*131*/u8"La distancia para la sección de instalación no puede ser <= al primer hectómetro",
	/*132*/u8"La distancia de la 'primera sección' no puede ser < que el primer hectómetro",
	/*133*/u8"ATENCIÓN: la longitud calculada del tramo del canal existente = 0",
	/*134*/u8"La longitud calculada del tramo del canal existente no coincide con la longitud establecida",
	/*135*/u8"La pendiente calculada del tramo del canal existente no coincide con la pendiente establecida",
	/*136*/u8"ATENCIÓN: la pendiente establecida del tramo del canal existente = 0",
	/*137*/u8"ATENCIÓN: la longitud calculada del tramo del canal proyectado = 0",
	/*138*/u8"La longitud calculada del tramo del canal proyectado no coincide con la longitud establecida",
	/*139*/u8"La pendiente calculada del tramo del canal proyectado no coincide con la pendiente establecida",
	/*140*/u8"ATENCIÓN: la pendiente establecida del tramo del canal proyectado = 0",
	/*141*/u8"La cota del canal existente es > 0, pero la longitud del tramo y la distancia = 0",
	/*142*/u8"La pendiente del canal existente es <> 0, pero la longitud del tramo y la distancia = 0",
	/*143*/u8"La cota del canal proyectado es > 0, pero la longitud del tramo y la distancia = 0",
	/*144*/u8"La pendiente del canal proyectado es <> 0, pero la longitud del tramo y la distancia = 0",
	/*145*/u8"La distancia y las longitudes del canal existente y proyectado = 0",
	/*146*/u8"Las distancias calculadas para el canal existente y proyectado son diferentes.",
	/*147*/u8"Falta la distancia establecida para la cota de la calle",
	/*148*/u8"Falta la distancia establecida para la cota del terreno",
	/*149*/u8"O.K. Se restauraron los datos de la medición anterior. Elimine el último bloque de medición.",
	/*150*/u8"<BETA> En la versión 'beta' actual, esta función no está activa...",
	/*151*/u8"La distancia para el sondeo geológico no puede ser < 0",
	/*152*/u8"La distancia para el sondeo geológico no puede ser <= al primer hectómetro",
	/*153*/u8"Se ingresó la distancia, pero falta (o es incorrecta) la cota del terreno para el sondeo",
	/*154*/u8"Valor negativo en una de las cotas respecto a la superficie del terreno.",
	/*155*/u8"Las cotas b.g.l. de las capas del sondeo no son incrementales",
	/*156*/u8"La cota b.g.l. de la primera capa = 0",
	/*157*/u8"Falta la cota del nivel de agua confinado habiéndose establecido la cota del nivel estabilizado",
	/*158*/u8"Falta la cota del nivel de agua estabilizado habiéndose establecido la cota del nivel confinado",
	/*159*/u8"La cota del nivel de agua estabilizado está por debajo del fondo del sondeo",
	/*160*/u8"La cota del nivel de agua confinado está por debajo del fondo del sondeo",
	/*161*/u8"La cota del nivel de agua libre está por debajo del fondo del sondeo",
	/*162*/u8"Falta la distancia establecida para la cota del terreno proyectado",
	/*163*/u8"Falta la distancia establecida para la cota del terreno existente",
	/*164*/u8"Se han marcado otras instalaciones sin ingresar la cota del terreno",
	/*165*/u8"La cota de filtración está por debajo del fondo del sondeo",
/*166*/u8"",
/*167*/u8"",
/*168*/u8"",
/*169*/u8"",
...
/*202*/u8"Error al leer archivo de imagen",
	/*203*/u8"Bloque paramétrico faltante o no válido en la capa de perfil. Ingrese los datos:",
	/*204*/u8"Valor no válido del factor de escala X/Y del perfil",
	/*205*/u8"Valor no válido del tipo de perfil",
	/*206*/u8"Valor no válido del primer hectómetro",
	/*207*/u8"¡ATENCIÓN! Bloque paramétrico faltante o no válido en la capa de perfil.",
	/*208*/u8"No hay buzones de recolección en la red establecida",
	/*209*/u8"Se ha descrito un único buzón en la red principal",
...
/*214*/u8"Número de capa fuera del rango de 1...2048",
/*215*/u8"Ninguno de los semiejes de la elipse puede tener una longitud menor que 0.",
/*216*/u8"Formato no válido para números reales no negativos",
};

static const char* komunikaty_kom[] =
/* 0*/{u8"",
...
/*115*/u8"Número máximo de capas: 2048",
...
/*120*/u8"",
	/*121*/u8"Desplazamiento del perfil desde la distancia [m]: ",
	/*122*/u8"-> por la distancia [m]: ",
	/*123*/u8"Seleccione el bloque de medición para obtener los parámetros",
	/*124*/u8"Distancia inicial [m]: ",
	/*125*/u8"Distancia final [m]: ",
	/*126*/u8"Ingrese el material: ",
	/*127*/u8"Ingrese el tipo de superficie: ",
	/*128*/u8"Ingrese el diámetro del canal proyectado [mm]: ",
	/*129*/u8"Ingrese el diámetro del canal existente [mm]: ",
	/*130*/u8"Seleccione el bloque de medición inicial",
	/*131*/u8"Seleccione el bloque de medición final",
	/*132*/u8"Ingrese la pendiente [‰]: ",
	/*133*/u8"Falta la cota del terreno proyectado",
	/*134*/u8"Falta la cota del terreno existente",
	/*135*/u8"Ingrese el valor de profundidad constante [m]: ",
...
/*151*/u8"",
/*152*/u8"",
	/*153*/u8"Ingrese la descripción de la primera medición de red: ",
/*154*/u8"Ingrese el factor de autopanorama 0.01...1 : ",
	/*155*/u8"Seleccione el bloque de red para insertar la conexión: ",
	/*156*/u8"Error al abrir el archivo de informe de trazas de red",
	/*157*/u8"No hay definición de trazas de red en el archivo",
	/*158*/u8"Error al leer el archivo de informe de trazas de red",
	/*159*/u8"Seleccione la red para generar el perfil",
...
/*177*/u8"",
/*178*/u8"",
	/*179*/u8"¿Generar perfil?",
	/*180*/u8"Error al guardar el archivo de informe de trazas de red",
/*181*/u8"",
...
/*185*/u8"¿Recargar bloque de imagen editado? (Sí / No / Esc): ",
	/*186*/u8"<Bloque paramétrico> Ingrese el factor de escala X/Y del perfil: ",
	/*187*/u8"<Bloque paramétrico> Ingrese la cota del nivel de referencia D.L.: ",
	/*188*/u8"<Bloque paramétrico> Ingrese el tipo de perfil (0..2): ",
	/*189*/u8"<Bloque paramétrico> Ingrese el valor del primer hectómetro: ",
	/*190*/u8"Seleccione la red para generar los buzones de recolección",
...
/*228*/u8"",
/*229*/u8"",
	/*230*/u8"El dibujo ha sido marcado como mapa de red",
	/*231*/u8"El dibujo ya está marcado como mapa de red",
	/*232*/u8"El dibujo ya está marcado como perfil de red",
/*233*/u8"¡PERFIL BLOQUEADO!",
/*234*/u8"",
};


static const char* komunikaty0[] =
/*0*/{ u8"",
/*1*/u8"Texto",
...
static char gg[10][24] = { u8"Punto final", u8"Extremo más cercano", u8"Medio", u8"Intersección", u8"Centro", u8"Perpendicular",
...
char _TO_MANY_OBJECTS_[]= u8"Se seleccionan demasiados objetos para continuar (el máximo es 6000)";
...
#define _PROFILE_COLORS_ u8"@Colores de los elementos del perfil/mapa"

#define _measurement_axis_          u8"Eje de medición"
#define _existing_ground_line_      u8"Línea de terreno existente"
#define _designed_ground_line_      u8"Línea de terreno proyectado"
#define _street_line_               u8"Línea de calle"
#define _existing_canal_line_       u8"Línea de canal existente"
#define _designed_canal_line_       u8"Línea de canal proyectado"
#define _elevation_values_          u8"Valores de cota"
#define _l_material_                u8"Φ, l, material"
#define _distances_                 u8"Distancias"
#define _hectometers_               u8"Hectómetros"
#define _installation_description_  u8"Descripción de instalación"
#define _T_symbol_                  u8"Símbolo 'T'"
#define _e_symbol_                  u8"Símbolo 'e'"
#define _G_symbol_                  u8"Símbolo 'G'"
#define _W_symbol_                  u8"Símbolo 'W'"
#define _K_symbol_                  u8"Símbolo 'K'"
#define _hole_axis_                 u8"Eje de sondeo"
#define _hole_number_               u8"Número de sondeo"
#define _hole_description_          u8"Descripción de sondeo"
#define _layers_description_        u8"Descripción de estratos"
#define _water_symbol_              u8"Símbolo de nivel freático"
#define _other_                     u8"Otros"


#define _OBJECT_COLORS_ u8"COLORES DE OBJETOS"
#define _PROFILE_ELEMENT_COLOR_CONFIGURATION_ u8"CONFIGURACIÓN DE COLOR DE ELEMENTOS DE PERFIL"
...
#define _PLATE_SECTION_ u8"Ingrese h;c (altura; recubrimiento axial"
#define _SHIELD_SECTION_ u8"Ingrese t;c (espesor; recubrimiento axial"
