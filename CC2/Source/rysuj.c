  ...
  while(1)
   {
     ...
     int n11=mWoodSpeciesUS.max;

    if ((n1>200) && (n1<=(200+n11))) n1=WOOD_CA;  //wood CAd sections
     else if ((n1>WOOD_US) && (n1<(WOOD_US+n11))) n1=WOOD_US;  //wood US sections
