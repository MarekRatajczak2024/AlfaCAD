...
/*105*/u8"Distance cannot be < 0",  //////////////////////////////////////////
	/*106*/u8"The profile scale factor value (scale x / scale Y) must be > 0",
	/*107*/u8"The distance is smaller than the one specified in the previous cross-section.",
	/*108*/u8"The distance of the 'first cross-section' cannot be < 0",
	/*109*/u8"The initial value in hectometers cannot be < 0",
	/*110*/u8"The final value in hectometers must be > or = the initial value.",
	/*111*/u8"Error: ScaleX/ScaleY = 0. Declare a scale ratio of > 0",
	/*112*/u8"The sum of the distances for the existing channel diameters exceeds the section length",
	/*113*/u8"The sum of the distances for the proposed channel diameters exceeds the section length",
	/*114*/u8"The specified lengths for the existing and proposed channels are not equal at distances > 0.",
	/*115*/u8"The specified length for the existing channel is < 0",
	/*116*/u8"The specified length for the proposed channel is < 0",
	/*117*/u8"The distance (in this variant) cannot be <= 0",
	/*118*/u8"The length for the existing channel slope exceeds the section length",
	/*119*/u8"The length for the proposed channel slope exceeds the section length",
	/*120*/u8"The slope of the existing channel exceeds the differences in the section elevations",
	/*121*/u8"The slope of the proposed channel exceeds the differences in the section elevations",
	/*122*/u8"Incorrect profile scale factor value. Select the /Profile Scale/ function",
	/*123*/u8"No data for the first measurement. Select the function /First measurement/",
/*124*/u8"Notice : Local origin point <0,0> is at the global origin point 0,0. Press any key:",
	/*125*/u8"Power cable selected without specifying the ground elevation",
	/*126*/u8"Telephone conduit selected without specifying the ground elevation",
	/*127*/u8"Telephone cable selected without specifying the ground elevation",
	/*128*/u8"Distance smaller than the initial value on the hectometer axis",
	/*129*/u8"Distance for the installation cross-section cannot be <= 0",
	/*130*/u8"Distance = to the first hectometer can only be specified for the 'first cross-section'",
	/*131*/u8"Distance for the installation cross-section cannot be <= to the first hectometer",
	/*132*/u8"Distance from the 'first cross-section' cannot be < from the first hectometer",
	/*133*/u8"NOTE: calculated length of the existing conduit section =0",
	/*134*/u8"Calculated length of the existing channel section does not match the specified length",
	/*135*/u8"Calculated slope of the existing channel section does not match the specified slope",
	/*136*/u8"NOTE: Specified slope of the existing channel section = 0",
	/*137*/u8"NOTE: Calculated length of the proposed channel section = 0",
	/*138*/u8"Calculated length of the proposed channel section does not match the specified length",
	/*139*/u8"Calculated slope of the proposed channel section does not match the specified slope",
	/*140*/u8"NOTE: Specified slope of the proposed channel section = 0",
	/*141*/u8"Elevation of the existing channel >0 but the length and distance =0",
	/*142*/u8"Slope of the existing channel <>0 but the length and distance =0",
	/*143*/u8"proposed channel elevation >0 but section length and distance =0",
	/*144*/u8"proposed channel slope <>0 but section length and distance =0",
	/*145*/u8"Distance and lengths of the existing and planned channel = 0",
	/*146*/u8"The determined distances for the existing and planned channel are different.",
	/*147*/u8"No distance set for the proposed grade (street ) elevation",
	/*148*/u8"No distance set for the grade elevation",
	/*149*/u8"O.K. Previous measurement data restored. Delete the last measurement block.",
	/*150*/u8"<BETA> In the current 'beta' version, this function is not active...",
	/*151*/u8"Distance for the geological borehole cannot be < 0",
	/*152*/u8"Distance for geological borehole cannot be <= first hectometer",
	/*153*/u8"Distance given, but no (or wrong) grade elevation for borehole",
	/*154*/u8"Negative value of one of the elevations relative to the grade surface.",
	/*155*/u8"Elevations below ground level of borehole layers are not incremental",
	/*156*/u8"Elevation below ground level of first layer = 0",
	/*157*/u8"No elevation of the confined water table at the given elevation of the stabilized water table",
	/*158*/u8"No elevation of the stabilized water table at the given elevation of the confined water table",
	/*159*/u8"Elevation of the stabilized water table below the bottom borehole",
	/*160*/u8"Elevation of the confined water table below the borehole bottom",
	/*161*/u8"Elevation of the free water table below the borehole bottom",
	/*162*/u8"No distance specified for the proposed grade elevation",
	/*163*/u8"No distance specified for the existing grade elevation",
	/*164*/u8"Other installations selected without specifying the grade elevation",
	/*165*/u8"Elevation of seepage below the borehole bottom",
/*166*/u8"",
/*167*/u8"",
/*168*/u8"",
/*169*/u8"",
...
/*202*/u8"Error reading image file",
	/*203*/u8"Missing or invalid parametric block on the profile layer. Enter data:",
	/*204*/u8"Invalid profile X scale value",
	/*205*/u8"Invalid profile type value",
	/*206*/u8"Invalid first hectometer value",
	/*207*/u8"WARNING! Missing or invalid parametric block on the profile layer.",
	/*208*/u8"No manhole in the specified utility",
	/*209*/u8"A single manhole is described in the main utility",
/*210*/u8"Enforced layer '0' setting as +V +E +P",
/*211*/u8"Internal error",
/*212*/u8"Error code: ",
/*213*/u8"Value out of range 1024 .. 2000000 [KB]",
/*214*/u8"Layer number out of the range of 1...2048",
...
/*115*/u8"The maximum layer number: 2047",
/*116*/u8"The minimum layer number: 1",
/*117*/u8"Layer doesn't exist.",
/*118*/u8"First symbol : ",
/*119*/u8"File not saved. Do you want to save itć ? (Yes / No / Esc): ",
/*120*/u8"",
	/*121*/u8"Profile offset from distance [m]: ",
	/*122*/u8"-> by distance [m]: ",
	/*123*/u8"Select measurement block object to obtain parameters",
	/*124*/u8"Start distance [m]: ",
	/*125*/u8"Final distance [m]: ",
	/*126*/u8"Enter material: ",
	/*127*/u8"Enter pavement type: ",
	/*128*/u8"Enter proposed channel diameter [mm]: ",
	/*129*/u8"Enter existing channel diameter [mm]: ",
	/*130*/u8"Select initial measurement block object",
	/*131*/u8"Select final measurement block object",
	/*132*/u8"Enter the slope [‰]: ",
	/*133*/u8"No elevation of the proposed grade",
	/*134*/u8"No elevation of the existing grade",
	/*135*/u8"Enter the value of the permanent depth [m]: ",
...
/*151*/u8"",
/*152*/u8"",
	/*153*/u8"Enter the label of the first utility point: ",
/*154*/u8"Enter the autopanorama factor 0.01...1 : ",
	/*155*/u8"Select the utility block object to insert the connection: ",
	/*156*/u8"Error opening the utility route report file",
	/*157*/u8"No utility route definitions in the file",
	/*158*/u8"Error reading the utility route report file",
	/*159*/u8"Select the utility to generate the profile",
...
/*177*/u8"",
/*178*/u8"",
	/*179*/u8"Generate profile?",
	/*180*/u8"Error saving utility routing report file",
/*181*/u8"",
...
/*185*/u8"Reload edited image block ? (Yes / No / Esc): ",
	/*186*/u8"<Parametric Block> Enter the X/Y scale factor of the profile: ",
	/*187*/u8"<Parametric Block> Enter the Datum level: ",
	/*188*/u8"<Parametric Block> Enter the profile type (0..2): ",
	/*189*/u8"<Parametric Block> Enter the value of the first hectometer: ",
	/*190*/u8"Specify the utility to generate manhole blocks",
...
/*228*/u8"",
/*229*/u8"",
	/*230*/u8"The drawing has been marked as a utility map",
	/*231*/u8"The drawing is already marked as a utility map",
	/*232*/u8"The drawing is already marked as a utility profile",
/*233*/u8"PROFILE BLOCKED!",
/*234*/u8"",
};
...
#define _PROFILE_COLORS_ u8"@Profile/map element colors"

#define _measurement_axis_          u8"Measurement Axis"
#define _existing_ground_line_      u8"Existing Ground Line"
#define _designed_ground_line_      u8"Proposed Ground Line"
#define _street_line_               u8"Street Line"
#define _existing_canal_line_       u8"Existing Channel Line"
#define _designed_canal_line_       u8"Proposed Channel Line"
#define _elevation_values_          u8"Elevation Values"
#define _l_material_                u8"Φ, l, Material"
#define _distances_                 u8"Distances"
#define _hectometers_               u8"Hectometers"
#define _installation_description_  u8"Utility Crossing Callout"
#define _T_symbol_                  u8"Symbol 'T'"
#define _e_symbol_                  u8"Symbol 'e'"
#define _G_symbol_                  u8"Symbol 'G'"
#define _W_symbol_                  u8"Symbol 'W'"
#define _K_symbol_                  u8"Symbol 'K'"
#define _hole_axis_                 u8"Borehole Axis"
#define _hole_number_               u8"Borehole Number"
#define _hole_description_          u8"Borehole Callout"
#define _layers_description_        u8"Strata Description"
#define _water_symbol_              u8"Water Table Symbol"
#define _other_                     u8"Other"


#define _OBJECT_COLORS_ u8"OBJECT COLORS"
#define _PROFILE_ELEMENT_COLOR_CONFIGURATION_ u8"PROFILE ELEMENT COLOR CONFIGURATION"
